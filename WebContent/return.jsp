	  ...
	  <script type="text/javascript">
		  $(function(){
			  $("#next").click(function(){
				  ...
				  page++;
				  location.href = "/Library/admin?method=getBorrowed&page="+page;
			  })
			  ...
			  $("#first").click(function () {
				  location.href = "/Library/admin?method=getBorrowed&page=1";
			  })

			  $("#last").click(function(){
				  var pages = parseInt($("#pages").html());
				  location.href = "/Library/admin?method=getBorrowed&page="+pages;
			  })
		  })
	  </script>
  </head>
    ...
    <%@ include file="top.jsp" %>
  	...
  	<div id="main">
		<div class="navigation">
				<a href="/Library/admin?page=1">借書管理</a>
		...
		<table class="table" cellspacing="0">
			...
			<tr>
				...
				<td>
					<a href="/Library/admin?method=handle&id=${borrow.id }&state=3">歸還</a>
				</td>
			</tr>
			</c:forEach>
